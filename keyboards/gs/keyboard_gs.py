...
button_6: InlineKeyboardButton = InlineKeyboardButton(text='ГС для для Кофеварок/Кофе машин', callback_data='gs-coffee-machine')
...
button_11: InlineKeyboardButton = InlineKeyboardButton(text='ГС для для мобильных кондиционеров', callback_data='gs-mobile-conditioner')
button_12: InlineKeyboardButton = InlineKeyboardButton(text='ГС для для фото, цифровой тех.', callback_data='gs-photo')
button_13: InlineKeyboardButton = InlineKeyboardButton(text='ГС для для электроинструмента', callback_data='gs-power-tool')
button_14: InlineKeyboardButton = InlineKeyboardButton(text='ГС для для водонагревателей', callback_data='gs-water-heater')
